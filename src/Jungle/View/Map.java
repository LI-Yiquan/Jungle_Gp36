...
public class Map implements Page{
    ...
    /**
     * Set the game information, such as what is the last step, the number of pieces of player 1 and 2
     * @param gameInfo
     */
    ...
    public void setInputRequirement(String inputRequirement) {
        ...
        "The input format should be [Piece,Direction,Action], eg.(Lion,l,),(Rat,R)";
    }
                    ...
                    if (j % 2 == 0) {
                        ...
                        switch(getGameBoard().board[10-r][c].l_type){
                            ...
                            case TRAP:
                                ...
                                if(lock==0) System.out.print("XXX");
                                break;
                            case RIVER:
                                lock = 0;
                                for(int p=0;p<8;p++){
     ...
     */
    public void printInputRequirement(){
     ...
     * may delete, controller will check
     */
